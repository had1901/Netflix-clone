  ...
  return (
    <Layout>
      <div className='min-h-screen container mx-auto px-2'>
        <div className='xl:grid grid-cols-10 items-start md:py-12 py-6'>
          <div className='col-span-2 stickky bg-dry border border-gray-800 p-6 rounded-md xl:mb-0 mb-5'>
            {
              // sidebar link
